...
<head>
    ...
    */
	...
	if ( !isset( $_SESSION['userToken']) || !isset( $_SESSION['tokenExpireTime']) || time() >= $_SESSION['tokenExpireTime'] )
	{
		...
		$tokenGenerator = new TokenGenerator("k6RPc_GMAIL_COM_AUT","o2JBw76CnFt3x9XRq","https://authservice.priaid.ch/login");
...
<body>
    ...
    <div>
        <a target="_blank" href="#"><img class="logo" alt="" src="#" /></a>
        <span ><a class="priaid-powered" target="_blank" href="#"> </a> </span>
    </div>
</body>
</html>
